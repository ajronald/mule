...
public class GroovyScriptTransformerFunctionalTestCase extends FunctionalTestCase {
  ...
  public void testInlineScript() throws Exception {
    ...
    MuleMessage response = client.request("test://inlineScriptTestOut", RECEIVE_TIMEOUT).getRight();
  ...
  public void testFileBasedScript() throws Exception {
    ...
    MuleMessage response = client.request("test://fileBasedScriptTestOut", RECEIVE_TIMEOUT).getRight();
    assertNotNull(response);
    assertEquals("hexxo", response.getPayload());
  }
  ...
  public void testReferencedTransformer() throws Exception {
    ...
    MuleMessage response = client.request("test://referencedTransformerTestOut", RECEIVE_TIMEOUT).getRight();
    assertNotNull(response);
    assertEquals("hexxo", response.getPayload());
  }
  ...
  public void testReferencedTransformerWithParameters() throws Exception {
    ...
    MuleMessage response = client.request("test://referencedTransformerWithParametersTestOut", RECEIVE_TIMEOUT).getRight();
    assertNotNull(response);
    assertEquals("hexxo", response.getPayload());
  }
