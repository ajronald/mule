...
public class GroovyRefreshableBeanTestCase extends AbstractRefreshableBeanTestCase {
  ...
  public static final String ON_CALL_RECEIVED =
      "import org.mule.runtime.core.api.MuleEventContext; import org.mule.runtime.core.api.lifecycle.Callable; public class GroovyDynamicScript implements Callable { public Object onCall(MuleEventContext eventContext) throws Exception{ return eventContext.getResult().getPayload() + \""
          + RECEIVED + "\"; }}";
