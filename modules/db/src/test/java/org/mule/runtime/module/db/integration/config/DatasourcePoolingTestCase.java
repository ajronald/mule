...
import static org.mule.functional.util.TestFunctions.failIfErrorFunction;

import org.mule.functional.util.TestFunctions;
...
public class DatasourcePoolingTestCase extends AbstractDatasourcePoolingTestCase {
  ...
  public void providesMultipleConnections() throws Exception {
    ...
    client.request("test://testOut", RECEIVE_TIMEOUT).getRight();
    client.request("test://testOut", RECEIVE_TIMEOUT).getRight();
  }
}
