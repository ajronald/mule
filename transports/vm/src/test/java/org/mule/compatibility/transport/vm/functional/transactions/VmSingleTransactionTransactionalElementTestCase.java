...
public class VmSingleTransactionTransactionalElementTestCase extends FunctionalTestCase {
  ...
  public void testTransactional() throws Exception {
    ...
    flow.process(event);
    MuleMessage message1 = muleContext.getClient().request("vm://out1?connector=vmConnector1", 1000).getRight();
    MuleMessage message2 = muleContext.getClient().request("vm://out2?connector=vmConnector1", 1000).getRight();
  ...
  public void testTransactionalDoesntFailWithAnotherResourceType() throws Exception {
    ...
    MuleMessage message1 = muleContext.getClient().request("vm://out1?connector=vmConnector1", 1000).getRight();
    MuleMessage message2 = muleContext.getClient().request("vm://out2?connector=vmConnector1", 1000).getRight();
    MuleMessage message3 = muleContext.getClient().request("vm://out3?connector=vmConnector1", 1000).getRight();
    assertThat(message1, notNullValue());
    assertThat(message2, notNullValue());
