...
public class FlowAsyncBeforeAfterOutboundTestCase extends AbstractIntegrationTestCase {
  ...
  public void testAsyncBefore() throws Exception {
    ...
    MuleMessage msgAsync = client.request("test://test.before.async.out", RECEIVE_TIMEOUT).getRight();
    MuleMessage msgOut = client.request("test://test.before.out", RECEIVE_TIMEOUT).getRight();
  ...
  public void testAsyncAfter() throws Exception {
    ...
    MuleMessage msgAsync = client.request("test://test.after.async.out", RECEIVE_TIMEOUT).getRight();
    MuleMessage msgOut = client.request("test://test.after.out", RECEIVE_TIMEOUT).getRight();
