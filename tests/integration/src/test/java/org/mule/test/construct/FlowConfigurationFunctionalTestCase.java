...
public class FlowConfigurationFunctionalTestCase extends AbstractIntegrationTestCase {
  ...
  public void testFlowAynchronous() throws Exception {
    ...
    MuleMessage message = muleContext.getClient().request("test://asynchronous-out", RECEIVE_TIMEOUT).getRight();
    assertNotNull(message);
    Thread thread = (Thread) message.getPayload();
    assertNotNull(thread);
  ...
  public void testAsyncAsynchronous() throws Exception {
    ...
    MuleMessage message = muleContext.getClient().request("test://asynchronous-async-out", RECEIVE_TIMEOUT).getRight();
    assertNotNull(message);
    Thread thread = (Thread) message.getPayload();
    assertNotNull(thread);
    assertNotSame(Thread.currentThread(), thread);
  ...
  public void testInOutFlow() throws Exception {
    ...
    assertEquals("0", getPayloadAsString(muleContext.getClient().request("test://inout-out", RECEIVE_TIMEOUT).getRight()));
  }
  ...
  public void testInOutAppendFlow() throws Exception {
    ...
    assertEquals("0inout", getPayloadAsString(client.request("test://inout-append-out", RECEIVE_TIMEOUT).getRight()));
  }
  ...
  public void testSplitAggregateFlow() throws Exception {
    ...
    final MuleMessage result = muleContext.getClient().request("test://split-aggregate-out", RECEIVE_TIMEOUT).getRight();
  ...
  public void testSplitAggregateListFlow() throws Exception {
    ...
    final MuleMessage result = muleContext.getClient().request("test://split-aggregate-list-out", RECEIVE_TIMEOUT).getRight();
  ...
  public void testSplitAggregateListFlowSingleItem() throws Exception {
    ...
    final MuleMessage result = client.request("test://split-aggregate-singleton-list-out", RECEIVE_TIMEOUT).getRight();
  ...
  public void testSplitFilterAggregateFlow() throws Exception {
    ...
    final MuleClient client = muleContext.getClient();
    final MuleMessage result = client.request("test://split-filter-aggregate-out", RECEIVE_TIMEOUT).getRight();
  ...
  public void testMessageChunkSplitAggregateFlow() throws Exception {
    ...
    MuleClient client = muleContext.getClient();
    final MuleMessage result = client.request("test://message-chunk-split-aggregate-out", RECEIVE_TIMEOUT).getRight();
  ...
  public void testWireTapFlow() throws Exception {
    ...
    final MuleClient client = muleContext.getClient();
    final MuleMessage result = client.request("test://wiretap-out", RECEIVE_TIMEOUT).getRight();
    final MuleMessage tapResult = client.request("test://wiretap-tap", RECEIVE_TIMEOUT).getRight();
  ...
  public void testAsyncOneWayEndpoint() throws Exception {
    ...
    MuleClient client = muleContext.getClient();
    final MuleMessage result = client.request("test://async-oneway-out", RECEIVE_TIMEOUT).getRight();
    final MuleMessage asyncResult = client.request("test://async-async-oneway-out", RECEIVE_TIMEOUT).getRight();
  ...
  public void testAsyncRequestResponseEndpoint() throws Exception {
    ...
    MuleClient client = muleContext.getClient();
    final MuleMessage result = client.request("test://async-requestresponse-out", RECEIVE_TIMEOUT).getRight();
    final MuleMessage asyncResult = client.request("test://async-async-requestresponse-out", RECEIVE_TIMEOUT).getRight();
  ...
  public void testMulticaster() throws Exception {
    ...
    final MuleClient client = muleContext.getClient();
    final MuleMessage result1 = client.request("test://multicaster-out1", RECEIVE_TIMEOUT).getRight();
    final MuleMessage result2 = client.request("test://multicaster-out2", RECEIVE_TIMEOUT).getRight();
    final MuleMessage result3 = client.request("test://multicaster-out3", RECEIVE_TIMEOUT).getRight();
  ...
  public void testPoll() throws Exception {
    MuleMessage message = muleContext.getClient().request("test://poll-out", RECEIVE_TIMEOUT).getRight();
    assertNotNull(message);
  ...
  public void testPollFlowRef() throws Exception {
    MuleMessage message = muleContext.getClient().request("test://poll2-out", RECEIVE_TIMEOUT).getRight();
    assertNotNull(message);
  ...
  public void testSubFlowMessageFilter() throws Exception {
    ...
    MuleMessage message = muleContext.getClient().request("test://messagefiltersubflow-out", RECEIVE_TIMEOUT).getRight();
    assertNotNull(message);
  }
