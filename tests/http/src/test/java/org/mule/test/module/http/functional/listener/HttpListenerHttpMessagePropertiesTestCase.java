...
public class HttpListenerHttpMessagePropertiesTestCase extends AbstractHttpTestCase {
  ...
  public void get() throws Exception {
    ...
    final MuleMessage message = muleContext.getClient().request("test://out", RECEIVE_TIMEOUT).getRight();
  ...
  public void xForwardedForHeader() throws Exception {
    ...
    final MuleMessage forwardedMessage = muleContext.getClient().request("test://out", RECEIVE_TIMEOUT).getRight();
